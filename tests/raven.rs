...
fn sol_trace() {
    ...
    // typed
    {
        ...
        let _amount: LotAmount<BASE> = market.from_raw_as_base(100);
        let amountq: LotAmount<QUOTE> = market.from_raw_as_quote(1971);

        assert_eq!(market.quote_lots_to_native(&amountq), NativeAmount::from_raw(&quote_mint, I80F48::from_num(19710000)));
